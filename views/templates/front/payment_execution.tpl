...
{include file="$tpl_dir./order-steps.tpl"}
	...
	<p class="cart_navigation">
		...
		<input type="hidden" size="70" name="TOKEN_MERCHANT" value="{$token_merchant}" /><br/>
		<input type="hidden" size="70" name="ERROR" value="{$error_message}" /><br/>
		<input type="hidden" size="5" name="SETTLEMENT_TYPE" value="{$settlement_type}" /><br/>
